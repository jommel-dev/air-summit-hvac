...
export class AppSidebarComponent {
  ...
  private readonly allNavItems: NavItem[] = [
    ...
    },
    {
      ...
      menuKey: 'projects',
      path: '/users/projects',
      icon: `<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none"><path d="M4 4h16v2H4V4zm0 4h16v2H4V8zm0 4h16v2H4v-2zm0 4h16v2H4v-2z" fill="currentColor"/></svg>`,
    },
    {
      name: 'Stakeholders',
      menuKey: 'customers',
    ...
    },
    {
      ...
      menuKey: 'sales_remittance',
      path: '/users/sales-remittance',
      icon: `<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none"><path fill-rule="evenodd" clip-rule="evenodd" d="M12 2.25C6.615 2.25 2.25 6.615 2.25 12S6.615 21.75 12 21.75 21.75 17.385 21.75 12 17.385 2.25 12 2.25ZM3.75 12a8.25 8.25 0 1 1 16.5 0 8.25 8.25 0 0 1-16.5 0Zm5.47 1.28a.75.75 0 0 1 0-1.06l2.25-2.25a.75.75 0 0 1 1.06 0l2.25 2.25a.75.75 0 1 1-1.06 1.06l-.97-.97V16a.75.75 0 0 1-1.5 0v-3.69l-.97.97a.75.75 0 0 1-1.06 0Z" fill="currentColor"/></svg>`,
    },
    {
      name: 'Purchase Order',
